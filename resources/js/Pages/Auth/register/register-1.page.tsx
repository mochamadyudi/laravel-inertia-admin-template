        ...
        <Card className="flex flex-col border w-full max-w-[450px] lg:w-[450px] pb-10 rounded-xl p-4 lg:p-6 space-y-6 relative z-[1]">
          <div className="space-y-7">
            ...
            <div className="!space-y-2">
              <Typography.Title level={2} className="!text-2xl !m-0">Sign Up</Typography.Title>
              <Flex gap={6}>
            ...
            >
              <div className="space-y-6">
                <Button htmlType="submit" type="primary" className="!w-full" icon={<LoginOutlined/>}>Sign Up</Button>
