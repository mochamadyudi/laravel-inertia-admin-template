...
import {InboxData, SentData} from "@/Pages/Dashboard/App/Mail/handlers/data";
...
Page.layout = (children: React.ReactNode) => {
  return (
    <MailLayout
      menu={{
        activeKey: route('dashboard.app.mail.sent'),
        defaultSelectedKeys: [route('dashboard.app.mail.sent')],
      }}
      type="dashboard"
      children={children}
