...
// @ts-ignore
import MD, {attributes} from "@/Pages/Dashboard/Components/Generals/button/markdown/ButtonLoading.md";
import { Button, Flex } from 'antd';


const ButtonLoadingPartial: React.FC<any> = ()=> {
...
export default ButtonLoadingPartial;
